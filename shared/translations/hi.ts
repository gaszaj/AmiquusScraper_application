export const hi = {
  about: {
    description:
      "We’re changing the way people find their perfect used car by making advanced monitoring technology accessible to everyone.",
    join: {
      cta: "See Open Positions",
      description:
        "We are always on the lookout for talented people who are passionate about technology and want to change the way people buy cars. Check out our current job openings and become a part of our mission at AMIQUUS.",
      heading: "Join Our Team",
    },
    meta: {
      description:
        "Discover AMIQUUS, our mission to transform how Indians buy used cars, and meet the team behind our smart car listing monitoring service.",
    ...
    mission: {
      ...
      items: {
        0: {
          description:
            "No need to keep checking different websites again and again—AMIQUUS will search automatically and send you updates on time.",
          title: "Bachaao Samay",
        },
        1: {
          description:
            "Be the first to know when a great deal comes up on AMIQUUS, so you get the upper hand in a market where every second counts.",
          title: "Find Best Deals",
        },
        2: {
          description:
            "Take smart decisions with full monitoring across many trusted car selling websites.",
    ...
    questions: {
      description:
        "Find out more about how AMIQUUS works, check out our pricing plans, or connect with our support team.",
      heading: "Any Doubts?",
      links: {
        faq: "Visit FAQ",
  ...
  alertSchema: {
    errors: {
      ...
      facebookmarketplaceurl:
        "Facebook Marketplace ka URL zaroori hai jab Facebook select kiya gaya ho",
  ...
  carDetails: {
    ...
    description:
      "Please enter the car details you are searching for. All fields are optional – you can leave any blank to see more results.",
    errors: {
      carbrand: "Car brand is required",
      carmodel: "Car model is mandatory",
      fueltype: "Fuel type is mandatory",
  ...
  dashboardPaymentMethodCard: {
    ...
    remove: "Delete",
    removedescription:
      "Are you sure you want to remove your {{brand}} card ending with {{last4}}?",
    ...
    setdefaultdescription:
      "Do you want to set the AMIQUUS card ending with {{last4}} as your default payment method? This card will be used for all your future subscription payments.",
    setdefaulttitle: "Set Default Payment Method",
  },
  dashboardSubscriptionCard: {
    cancelalert: "Cancel Alert",
    canceldescription:
      "Are you sure you want to cancel your car alert for {{brand}} {{model}}? All notifications will stop and if you want to track this car again, you’ll have to set a new alert.",
  ...
  faq: {
    ...
    questions: {
      0: {
        answer:
          "Notification speed depends on the update frequency you select. With the default hourly plan, you’ll get notified within one hour after a new listing is posted. If you want almost instant notifications (within a few minutes of posting), you can upgrade to our faster update plans.",
        question: "How soon will I get notified after a new listing is posted?",
      },
      1: {
        answer:
          "Yes! You can make multiple search profiles with different filters. Each profile will be counted as a separate subscription, but you can handle all of them from one account only. This is very useful if you are searching for different types of vehicles at the same time.",
        question:
          "Can I track many different types of cars together at the same time?",
      },
      2: {
        answer:
          "Right now, we support all the big car listing sites like AutoTrader, CarGurus, Cars.com, and Facebook Marketplace. We’re always adding more websites to AMIQUUS based on what people want and what’s popular in different parts of India.",
        question: "Which websites does AMIQUUS support right now?",
      },
      3: {
        answer:
          "Bilkul bhi nahi! Hum aapko step-by-step instructions dete hain, jismein text aur video guides dono shamil hain, taki aap asaani se Telegram bot setup kar sakein. Zyadatar users bina kisi technical background ke 5 minute se kam mein setup complete kar lete hain.",
        question:
          "Kya mujhe Telegram bot use karne ke liye technical knowledge chahiye?",
      },
      4: {
        answer:
          "Yes, you can change your search settings anytime from your account dashboard. The changes will be applied instantly, and your notifications will get updated right away without any break in your service.",
        question:
          "Can I update my search preferences after setting up my AMIQUUS subscription?",
      },
      5: {
        answer:
          'You can cancel your subscription anytime from your account dashboard. Just go to the "Subscriptions" section, pick the subscription you want to cancel, and click on the "Cancel Subscription" button. Your service will stay active till the end of your current billing cycle.',
        question: "How can I cancel my AMIQUUS subscription?",
      },
    },
    subtitle:
      "Get answers to the most frequently asked questions about AMIQUUS services.",
  ...
  faqs: {
    general: {
      ...
      whatis: {
        answer:
          "Amiquus is a service that keeps an eye on multiple car selling websites for vehicles matching your exact needs. Whenever a suitable car is listed, you get an instant alert on Telegram, so you can be one of the first to contact the seller and grab the best deals.",
        question: "Amiquus kya hai?",
      },
      whichwebsites: {
        answerintro:
          "Right now, we are keeping an eye on these top car listing platforms:",
        list: {
          0: "AutoTrader",
          1: "Cars.com",
          2: "AMIQUUS",
        ...
        outro:
          "We are always adding new platforms so you get the most complete coverage on AMIQUUS.",
        question: "Which car selling websites do you check?",
      },
    },
    metaDescription:
      "Get answers to all your common questions about AMIQUUS car listing monitoring, subscriptions, notification settings, and much more.",
    ...
    subscription: {
      cancel: {
        ...
        stepsintro:
          "You can cancel your subscription anytime from your account profile page.",
      },
      cost: {
        answer: {
      ...
      limit: {
        intro:
          "We are keeping our service limited to 30 active subscribers so that we can ensure:",
        list: {
        ...
        outro:
          "If we are full, you can join our waitlist and we will let you know when a spot opens up.",
        question: "Why is there a limit on the number of subscribers?",
      },
      multiple: {
        answer:
          "Yes, you can make multiple subscriptions with one account on AMIQUUS. Each subscription can follow different car models, brands, or price ranges. This is very helpful if you are looking for more than one car or helping your friends and family to find a car.",
        question: "Can I take multiple subscriptions for different car models?",
      },
    },
    subtitle:
      "Get quick answers to common questions about our car listing monitoring service on AMIQUUS",
    support: {
      button: "Contact Support",
      description:
        "If you didn’t find the answer to your question, our AMIQUUS support team is always ready to help you!",
    ...
    technical: {
      frequency: {
        ...
        outro:
          "You’ll get notifications only when new listings matching your preferences are found.",
        question: "Kitni baar mujhe notifications milenge?",
      },
      heading: "Technical Queries",
      privacy: {
        intro:
          "We take your data privacy seriously and follow these steps to protect it:",
        list: {
        ...
        outro:
          "Please read our complete Privacy Policy on AMIQUUS for more details.",
  ...
  features: {
    account: {
      description:
        "Easily manage multiple search profiles and update your subscription settings in just a few clicks.",
      title: "Simple Account Management",
    },
    filters: {
      description:
        "Set your exact preferences like brand, model, year, kilometers driven, and price range to find just what you’re looking for.",
      title: "Custom Filters",
    },
    frequency: {
      description:
        "Select how often you want us to check for new listings, from hourly updates to real-time tracking.",
    ...
    multisite: {
      description:
        "Track multiple car listing websites at once on AMIQUUS, no need to check each site manually.",
      title: "Track Multiple Websites",
    },
    notifications: {
      description:
        "Get instant alerts on Telegram when a car matching your preferences is listed for sale.",
      title: "Instant Alerts",
    },
    subheading:
      "Save your time and never miss your perfect car with AMIQUUS automatic tracking service.",
  },
  footer: {
    about: "About Us",
    blog: "Blog",
    branddescription:
      "Your personal assistant to help you find the best used car deal at just the right time.",
    brandtitle: "Amiquus",
    careers: "Jobs",
  ...
  hero: {
    ...
    subtitle:
      "Amiquus instantly notifies you when your dream car is available on any car selling website. Get updates on Telegram as soon as a match is found.",
  ...
  howItWorks: {
    ...
    notificationmockup2: {
      description:
        "Mercedes C-Class, 2020, 30,000 km - Price reduced by ₹1,65,000",
    ...
    steps: {
      findcar: {
        description:
          "Be the first to know about new listings on AMIQUUS and grab the best deals before anyone else.",
        title: "Find Your Perfect Car",
      },
      notifications: {
        description:
          "Get instant alerts as soon as a car matching your needs shows up on any of the websites we track.",
        title: "Get Instant Alerts",
      },
      preferences: {
        description:
          "Choose car brands, models, price range, and other filters you want to keep track of.",
        title: "Set Your Preferences",
      },
      telegram: {
        description:
          "Link your Telegram account to get instant alerts about new listings.",
        title: "Connect Telegram",
      },
    },
    subtitle:
      "Set up once and let our automated system find the best car deal for you",
  ...
  limited: {
    available: {
      ...
      description:
        "{{active}} out of {{capacity}} subscriptions are active right now. There's still plenty of space for you to join!",
      title: "Plans Available",
    },
    full: {
      buttonText: "Join Waiting List",
      description:
        "We have reached our limit of 30 active subscribers. Please join our waitlist to get notified when a spot becomes available.",
      title: "You have reached your subscription limit",
    },
    limited: {
      buttonText: "Start Now",
      description:
        "Only {{remaining}} slots left out of {{capacity}}. Hurry up and subscribe before all seats are full!",
      title: "Limited Stock Available",
    },
  },
  login: {
    description:
      "Please enter your email and password to login to your AMIQUUS dashboard.",
    emaillabel: "Email",
    errors: {
  ...
  loginPrompt: {
    description:
      "You need to be logged in to continue. Please login or register on AMIQUUS.",
    login: "Sign In",
    register: "Sign Up",
    title: "Login Needed",
  },
  navigations: {
    faq: "Frequently Asked Questions",
    features: "Key Features",
    getalerts: "Get Notifications",
    getstarted: "Get Started",
    how: "How It Works",
    language: "Language",
    login: "Sign in",
    logout: "Log Out",
    myalerts: "Mere Alerts",
    pricing: "Pricing",
    profile: "Profile",
    settings: "Settings",
  ...
  personalInfo: {
    ...
    description:
      "Please share your personal details so that we can set up your notifications properly.",
    errors: {
  ...
  pricing: {
    ...
    button: "Start Karein",
    footernote:
      "Sabhi plans mein unlimited search configurations aur aasaan subscription management shamil hai.",
    includedfeatures: {
    ...
    subtitle:
      "Our pricing is flexible as per your needs. Start with a basic package and customise it as per your requirements.",
    title: "Simple aur Transparent Pricing",
  },
  privacy: {
    lastupdated: "Last updated on: 21 May 2025",
    metaDescription:
      "Find out how AMIQUUS manages your personal data, privacy rights, and data collection practices.",
  ...
  profile: {
    ...
    alerts: {
      ...
      warning:
        "⚠️ Aapke subscription mein koi bhi badlav agle billing period mein hi lagu honge, woh bhi tab jab payment safalta se ho jaye. Agar payment fail ho jata hai, toh aapka current alert setup waise ka waise hi rahega.",
    },
    logout: {
  ...
  review: {
    ...
    description:
      "Kindly check your subscription details before making the payment.",
    monitoring: {
  ...
  setupAlerts: {
    ...
    subtitle:
      "Set up your Telegram bot to get updates about your dream car on AMIQUUS",
    title: "Set Car Alerts for Your Vehicle",
    toasts: {
      contactbot: {
        description:
          "To get car alerts, you need to start a chat with our Telegram bot and send a message. Please follow the steps below to contact the bot.",
      ...
      terms: {
        description:
          "You need to accept the terms of service to continue on AMIQUUS.",
        title: "Terms not accepted",
      },
    },
  },
  signUp: {
    ...
    subheading:
      "Set up your personalised car alerts on AMIQUUS in just a few easy steps.",
    toast: {
      error: {
        description:
    ...
    waitlist: {
      cta: "Join Waitlist",
      message:
        "Right now, we are full. Please join our waitlist and we’ll let you know as soon as a spot is available.",
    },
  },
  subscription: {
    actions: {
    ...
    description:
      "You can pause your subscription anytime. Once you pause it, your car alerts from AMIQUUS will stop till you start them again.",
    ...
    toasts: {
      ...
      priceerror: {
        description:
          "You are trying to pause and update your subscription price together. Please either pause or update the price, not both at the same time.",
  ...
  support: {
    ...
    faqs: {
      cancel: {
        answer:
          'You can cancel your subscription anytime from your account profile page. Just click on the "Subscriptions" tab, find the subscription you want to cancel, and hit the "Cancel Subscription" button. Your service will stay active till the end of your current billing cycle.',
        question: "How can I cancel my AMIQUUS subscription?",
      },
      facebook: {
        answer:
          "Yes, we support Facebook Marketplace monitoring. To set this up, you just need to give the URL of the Facebook Marketplace search page with your preferred filters. Our system will then keep an eye on that search and alert you whenever new listings matching your criteria come up.",
        question: "Can I track Facebook Marketplace?",
      },
      full: {
        answer:
          "To ensure we give you the best service, we keep a limit on active subscriptions. If all spots are taken, you can join our waiting list. We’ll inform you as soon as a spot opens up, and you’ll get first chance to grab it before we make it available for everyone.",
        question:
          "What will happen if all the subscription slots are already taken?",
      },
      telegram: {
        intro: "To set up Telegram notifications, just follow these steps:",
        outro:
          "If you need more help, you can find our detailed guide in your dashboard.",
      ...
      updates: {
        answer:
          "The update frequency depends on your subscription plan. Basic plans get updates every 6 hours, while Premium plans can get updates as often as every 30 minutes. You can check and change your current update frequency in your subscription settings.",
        question: "How frequently are car listings updated?",
      },
    },
    metaDescription:
      "Get help for your AMIQUUS account, subscription, or car alerts. Check out our help centre or reach out to our support team if you need any assistance.",
    metaTitle: "Support | Amiquus - Help Centre",
    stillneedhelp: {
      button: "Contact Support",
      description:
        "If you didn’t find the answer to your question, please contact our support team at AMIQUUS. We are always here to help you!",
  ...
  telegram: {
    ...
    contactbotinstruction:
      "Start a chat with our Telegram bot by clicking the link below and sending a message to it:",
    contactbotnote:
      "This is needed to get car alerts. If you are using a computer, you can scan the QR code.",
    description:
      "Set up Telegram notifications by entering your bot token and chat ID.",
    errors: {
    ...
    usernamedescription:
      "Yeh aapke Telegram account ka username hai (bina @ wale symbol ke).",
  ...
  terms: {
    ...
    metaDescription:
      "Please read the AMIQUUS Terms of Service to understand how you can use our car listing monitoring and notification service.",
  ...
  waitlist: {
    cantjoin: {
      description:
        "We’ll let you know as soon as a subscription spot opens up.",
      title: "Join the Waitlist",
    },
    form: {
      email: {
        description:
          "We’ll use this email to inform you when a spot is available.",
        label: "Email",
    ...
    limited: {
      available:
        "{{remaining}} subscription slots out of {{capacity}} are available right now.",
      description:
        "We are keeping our system limited to only 30 active subscribers to make sure:",
    ...
    metaDescription:
      "Join the AMIQUUS waitlist to get notified when subscriptions are open.",
    metaTitle: "Join the Waitlist - Amiquus",
    subtitle:
      "Because of heavy demand, we are keeping a limit on active subscriptions to make sure everyone gets the best service quality.",
    success: {
      button: "Go back to Homepage",
      description:
        "We’ll let you know as soon as a subscription spot opens up.",
      message:
        "Thank you for showing interest in AMIQUUS! We have added you to our waitlist and will reach out to you as soon as a spot is available.",
  ...
  waitlistPrompt: {
    ...
    description:
      "Right now, all slots are full. Join the waitlist to get notified when a spot opens up.",
    title: "Join the Waitlist",
  },
  websiteSelection: {
    actions: {
    ...
    description:
      "Select karo kaunse websites ko aap monitor karna chahte ho aur kitni baar aapko updates chahiye.",
    errors: {
      facebookurl:
        "Facebook Marketplace ka URL zaroori hai jab Facebook select kiya gaya ho",
    ...
    help: {
      ...
      updatefrequency:
        "How often should we check for new listings? Checking more frequently might increase the cost.",
