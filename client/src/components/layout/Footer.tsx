      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <p className="text-neutral-400 mb-4">Your personal assistant for finding the perfect used car deal at the perfect time.</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/terms#cookies" className="text-neutral-400 hover:text-white transition-colors">
                  Cookie Policy
                </Link>
              </li>
              <li>
                <Link href="/privacy#gdpr" className="text-neutral-400 hover:text-white transition-colors">
                  GDPR Compliance
                </Link>
              </li>
            </ul>
