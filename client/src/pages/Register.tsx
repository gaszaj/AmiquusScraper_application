...
export default function Register() {
  ...
  return (
    <>
      <Helmet>
        <title>Create an Account - Amiquus</title>
        <meta 
          name="description" 
          content="Sign up for Amiquus to start tracking used car listings across multiple websites and get instant notifications." 
        />
      </Helmet>
