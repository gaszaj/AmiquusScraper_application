...
export default function Register() {
  ...
  const { login, isAuthenticated, isLoading, register } = useAuth();
      ...
      <Card className="w-full max-w-md shadow-lg dark:border-neutral-800 dark:bg-neutral-800/50">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-start space-x-2 pt-2">
              ...
              <div className="grid gap-1.5 leading-none">
                ...
                >
                  I agree to the{" "}
                  <Link href="/terms" className="text-primary hover:underline dark:text-[#ff0]">
                    Terms of Service
                  </Link>{" "}
                  and{" "}
                  <Link href="/privacy" className="text-primary hover:underline dark:text-[#ff0]">
                    Privacy Policy
                  </Link>
                </label>
              </div>
        ...
        <CardFooter className="flex flex-col border-t dark:border-neutral-700 pt-4">
          <p className="text-center text-sm text-neutral-600 dark:text-neutral-400">
            ...
            <Link href="/login" className="text-primary hover:underline dark:text-[#ff0]">
              Log in
            </Link>
          </p>
        </CardFooter>
