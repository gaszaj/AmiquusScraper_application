export const ko = {
  ...
  hero: {
    ...
    subtitle: "Amiquus는 여러 자동차 매물 사이트에서 원하는 차량이 등록되면 즉시 알려드립니다. 매칭이 되면 텔레그램으로 바로 알림을 받아보세요.",
    button1: "알림 설정하기",
    button2: "작동 방식 보기",
    trustIndicators: {
  ...
  limited: {
    full: {
      title: "구독 한도에 도달했습니다",
      description: "현재 30명의 활성 구독자 한도에 도달했습니다. 자리가 생기면 알림을 받으시려면 대기자 명단에 등록해 주세요.",
      buttonText: "웨이팅리스트 신청"
    },
    limited: {
      title: "한정 수량",
      description: "총 {{capacity}}명 중 {{remaining}}자리만 남았습니다. 정원 마감 전에 지금 바로 구독하세요!",
      buttonText: "지금 시작하기"
    },
    available: {
      title: "구독 가능",
      description: "현재 {{capacity}}개 중 {{active}}개의 구독이 활성화되어 있습니다. 아직 가입하실 수 있는 충분한 자리가 있습니다!",
      buttonText: "지금 시작하기"
    }
  },
  features: {
    ...
    notifications: {
      title: "즉시 알림",
      description: "차량 조건에 맞는 매물이 등록되면 Telegram으로 즉시 알림을 받아보세요."
    },
    filters: {
      title: "맞춤 필터",
      description: "브랜드, 모델, 연식, 주행거리, 가격 범위 등 정확한 조건을 설정해 원하는 차량을 찾아보세요."
    },
    frequency: {
      title: "주파수 맞춤 설정",
  ...
  howItWorks: {
    title: "Amiquus 이용 방법",
    subtitle: "한 번만 설정하면 AMIQUUS의 자동 시스템이 완벽한 자동차 딜을 찾아드립니다.",
    whyTitle: "Why Choose Amiquus?",
    steps: {
      preferences: {
        title: "환경 설정",
        description: "관심 있는 자동차 브랜드, 모델, 가격대 및 기타 조건을 선택하세요."
      },
      telegram: {
        title: "텔레그램 연결",
        description: "텔레그램 계정을 연동하면 신규 매물 알림을 바로 받아보실 수 있습니다."
      },
      notifications: {
        title: "즉시 알림 받기",
  ...
  pricing: {
    title: "간단하고 투명한 요금제",
    subtitle: "AMIQUUS의 가격은 고객님의 개별적인 필요에 따라 책정됩니다. 기본 패키지로 시작하여 원하는 대로 맞춤 설정하세요.",
  ...
  websiteSelection: {
    ...
    help: {
      websites: "자동차 매물 모니터링을 위해 하나 이상의 웹사이트를 선택하세요.",
  ...
  carDetails: {
    heading: "차량 정보",
    description: "찾으시는 차량 정보를 입력해 주세요. 모든 항목은 선택 사항이며, 비워두시면 더 다양한 결과를 확인하실 수 있습니다.",
    labels: {
      carBrand: "Car Brand",
      carModel: "Car Model",
      fuelType: "Fuel Type",
  ...
  faq: {
    ...
    questions: {
      0: {
        answer: "알림 속도는 선택하신 업데이트 빈도에 따라 달라집니다. 기본 시간제 플랜을 이용하시면 새 매물이 등록된 후 한 시간 이내에 알림을 받으실 수 있습니다. 거의 실시간(게시 후 몇 분 이내) 알림을 원하신다면 더 자주 업데이트되는 플랜으로 업그레이드하실 수 있습니다.",
        question: "새로운 매물이 등록되면 알림을 얼마나 빨리 받을 수 있나요?"
      },
      1: {
        answer: "네! 다양한 기준으로 여러 검색 프로필을 생성할 수 있습니다. 각 프로필은 별도의 구독으로 간주되지만, 하나의 계정에서 모두 관리할 수 있습니다. 동시에 여러 종류의 차량을 찾고 있다면 아주 편리합니다.",
        question: "여러 종류의 자동차를 한 번에 추적할 수 있나요?"
      },
      2: {
        answer: "현재 AMIQUUS는 AutoTrader, CarGurus, Cars.com, Facebook Marketplace 등 주요 자동차 매물 플랫폼을 지원하고 있습니다. 사용자 요청과 지역별 인기 사이트를 반영하여 더 많은 웹사이트로 서비스를 지속적으로 확대하고 있습니다.",
        question: "현재 어떤 웹사이트를 지원하나요?"
      },
      3: {
        answer: "전혀 어렵지 않아요! 저희는 텍스트와 영상 가이드로 단계별 안내를 제공하여 Telegram 봇을 쉽게 설정할 수 있도록 도와드립니다. 대부분의 사용자는 기술 지식이 없어도 5분 이내에 설정을 완료합니다.",
        question: "텔레그램 봇을 사용하려면 기술적인 지식이 필요한가요?"
      },
      4: {
        answer: "네, 언제든지 내 계정 대시보드에서 검색 기준을 수정할 수 있습니다. 변경 사항은 즉시 적용되며, 알림도 서비스 중단 없이 바로 업데이트됩니다.",
  ...
  profile: {
    ...
    alerts: {
      ...
      cta: "첫 알림을 만들어보세요",
      warning: "⚠️ 구독 변경 사항은 다음 결제 주기에 성공적으로 결제가 완료된 후 적용됩니다. 결제에 실패할 경우, 현재 알림 설정은 변경되지 않습니다."
    },
    payments: {
      title: "결제 방법",
  ...
  loginPrompt: {
    title: "로그인이 필요합니다",
    description: "계속하려면 로그인해야 합니다. 로그인하거나 회원가입을 해주세요.",
    register: "회원가입",
    login: "로그인"
  },
  waitlistPrompt: {
    title: "웨이팅리스트 신청",
    description: "현재 정원이 모두 찼습니다. 자리가 생기면 알림을 받으시려면 대기자 명단에 등록해 주세요.",
    button: "웨이팅리스트 신청"
  },
  subscription: {
    title: "구독 정보",
    ...
    description: "언제든지 구독을 일시 중지할 수 있습니다. 구독을 일시 중지하면 차량 알림이 중단되며, 다시 시작할 때까지 알림이 제공되지 않습니다.",
    form: {
      status: {
        label: "상태",
        placeholder: "상태 선택",
    ...
    toasts: {
      success: {
        title: "구독이 업데이트되었습니다",
        description: "{{brand}} {{model}}에 대한 구독이 성공적으로 업데이트되었습니다."
      },
      priceError: {
  ...
  about: {
    title: "Amiquus 소개",
    description: "우리는 첨단 모니터링 기술을 모두에게 제공하여 사람들이 완벽한 중고차를 찾는 방식을 혁신하고 있습니다.",
    meta: {
      title: "회사 소개 | Amiquus - 자동차 매물 모니터링 서비스",
      description: "AMIQUUS와 함께 중고차 구매 방식을 혁신하려는 우리의 미션, 그리고 지능형 차량 매물 모니터링 서비스를 만드는 팀을 소개합니다."
    },
    story: {
      heading: "저희 이야기",
      paragraphs: {
    ...
    mission: {
      ...
      items: {
        0: {
          description: "여러 웹사이트를 계속 새로고침할 필요 없이, 검색 과정을 자동화하고 실시간 알림을 받아보세요.",
          title: "시간 절약"
        },
        1: {
          description: "최고의 혜택이 나타나면 가장 먼저 알아보세요. 타이밍이 중요한 경쟁 시장에서 우위를 선점할 수 있습니다.",
          title: "더 좋은 딜 찾기"
        },
        2: {
          description: "여러 신뢰할 수 있는 자동차 매물 플랫폼을 한눈에 모니터링하여 현명하게 결정하세요.",
          title: "안심하고 구매하세요"
        }
      }
    },
    ...
    join: {
      ...
      description: "AMIQUUS는 기술에 열정을 가지고 자동차 구매 경험을 혁신하고자 하는 재능 있는 인재를 항상 찾고 있습니다. 현재 채용 중인 포지션을 확인하시고, 우리의 미션에 함께하세요.",
      cta: "채용 공고 보기"
    },
    questions: {
      heading: "궁금한 점이 있으신가요?",
      description: "AMIQUUS 서비스 이용 방법, 요금제 확인 또는 고객 지원팀에 문의해보세요.",
      links: {
        faq: "자주 묻는 질문 보기",
        pricing: "가격 보기",
        support: "고객 지원 문의"
  ...
  terms: {
    ...
    metaDescription: "AMIQUUS 서비스 약관을 읽고 차량 매물 모니터링 및 알림 서비스 이용에 관한 내용을 확인하세요.",
    title: "이용약관",
  ...
  privacy: {
    ...
    metaDescription: "AMIQUUS가 여러분의 개인정보, 프라이버시 권리, 데이터 수집 방식을 어떻게 처리하는지 알아보세요.",
    title: "개인정보처리방침",
    lastUpdated: "Last updated: May 21, 2025",
    sections: {
      0: {
  ...
  faqs: {
    ...
    metaDescription: "AMIQUUS 차량 매물 모니터링 서비스, 구독, 알림 설정 등 자주 묻는 질문에 대한 답변을 찾아보세요.",
    title: "자주 묻는 질문",
    subtitle: "자동차 매물 모니터링 서비스에 대한 자주 묻는 질문을 빠르게 확인하세요",
    general: {
      heading: "자주 묻는 질문",
      whatIs: {
    ...
    subscription: {
      ...
      multiple: {
        ...
        answer: "네, 하나의 계정으로 여러 개의 구독을 생성할 수 있습니다. 각 구독마다 다른 자동차 모델, 브랜드, 가격대를 추적할 수 있어요. 여러 대의 차량을 찾거나 친구, 가족의 차량 검색을 도와줄 때 특히 유용합니다."
      },
      limit: {
        ...
        outro: "정원이 모두 찼을 경우, 자리가 나면 알림을 받으실 수 있도록 대기자 명단에 등록하실 수 있습니다."
      }
    },
    technical: {
      heading: "기술 문의",
      ...
      privacy: {
        ...
        intro: "저희는 데이터 개인정보 보호를 매우 중요하게 생각하며 다음과 같은 조치를 적용합니다:",
        list: {
          0: "전송 및 저장 시 데이터 암호화",
          1: "Stripe를 통한 안전한 결제",
          2: "제3자와 데이터 공유 없음",
    ...
    support: {
      ...
      description: "궁금하신 점에 대한 답변을 찾지 못하셨다면, AMIQUUS 고객지원팀이 도와드리겠습니다!",
      button: "고객 지원 문의"
    }
  },
  waitlist: {
    metaTitle: "웨이팅리스트 신청 - Amiquus",
    metaDescription: "AMIQUUS 대기자 명단에 등록하시면 구독 서비스가 출시될 때 안내해드립니다.",
    title: "웨이팅리스트에 등록하기",
    subtitle: "높은 수요로 인해 모든 이용자에게 최상의 서비스 품질을 제공하기 위해 활성 구독 수를 제한하고 있습니다.",
    limited: {
      heading: "한정 수량",
      description: "저희 시스템은 30명의 활성 구독자로 제한하여 다음을 보장합니다:",
      points: {
      ...
      available: "현재 {{capacity}}개 중 {{remaining}}개의 구독 자리가 남아 있습니다.",
      full: "현재 모든 구독 자리가 마감되었습니다. 자리가 생기면 알림을 받으시려면 대기자 명단에 등록해 주세요."
    },
    success: {
      title: "웨이팅리스트에 등록되셨습니다!",
      description: "구독 자리가 생기는 즉시 알려드리겠습니다.",
      message: "Amiquus에 관심 가져주셔서 감사합니다! 대기자 명단에 등록되었으며, 자리가 나면 바로 연락드리겠습니다.",
      button: "홈페이지로 돌아가기"
    },
    cantJoin: {
  ...
  support: {
    ...
    metaDescription: "AMIQUUS 계정, 구독 또는 차량 알림에 대한 도움을 받아보세요. 도움말 센터를 찾아보거나 지원팀에 문의해 주세요.",
    title: "고객센터",
    ...
    faqs: {
      telegram: {
        ...
        outro: "추가 도움이 필요하시면, 자세한 가이드는 대시보드에서 확인하실 수 있습니다."
      },
      updates: {
        question: "자동차 매물 정보는 얼마나 자주 업데이트되나요?",
        answer: "업데이트 빈도는 가입하신 요금제에 따라 다릅니다. 베이직 요금제는 6시간마다 업데이트가 제공되며, 프리미엄 요금제는 최대 30분마다 업데이트를 받을 수 있습니다. 현재 업데이트 빈도는 구독 설정에서 확인하고 변경하실 수 있습니다."
      },
      facebook: {
        question: "페이스북 마켓플레이스를 모니터링할 수 있나요?",
        answer: "네, 저희는 Facebook Marketplace 모니터링을 지원합니다. 설정하려면 원하는 필터가 적용된 Facebook Marketplace 검색 결과 페이지의 URL을 입력해 주세요. 그러면 저희 시스템이 해당 검색을 실시간으로 모니터링하여 회원님의 조건에 맞는 새로운 상품이 등록될 때 알려드립니다."
      },
      cancel: {
        question: "구독을 어떻게 취소하나요?",
        answer: "언제든지 내 계정 프로필 페이지에서 구독을 취소할 수 있습니다. \"구독\" 탭을 클릭하고, 취소하려는 구독을 찾아 \"구독 취소\" 버튼을 클릭하세요. 현재 결제 기간이 끝날 때까지 서비스가 계속 제공됩니다."
      },
      full: {
        question: "모든 구독 슬롯이 꽉 차면 어떻게 되나요?",
        answer: "고품질 서비스를 유지하기 위해 활성 구독 수를 제한하고 있습니다. 모든 자리가 꽉 찬 경우, 대기자 명단에 등록하실 수 있습니다. 자리가 마련되는 즉시 안내해 드리며, 일반 공개 전에 우선적으로 이용하실 수 있습니다."
      }
    },
    stillNeedHelp: {
