export const et = {
  about: {
    description:
      "Me muudame revolutsiooniliselt seda, kuidas inimesed leiavad oma ideaalse kasutatud auto, tuues kõigile kättesaadavaks täiustatud jälgimistehnoloogia.",
    join: {
      cta: "Vaata vabu töökohti",
      description:
        "Otsime alati andekaid inimesi, keda paelub tehnoloogia ning kes soovivad muuta auto ostmise kogemust. Vaata meie praeguseid vabu töökohti ja liitu AMIQUUS missiooniga.",
      heading: "Liitu meie meeskonnaga",
    },
    meta: {
      description:
        "Tutvu AMIQUUSega, meie missiooniga muuta kasutatud autode ostmine revolutsiooniliseks ning tiimiga, kes seisab meie nutika autokuulutuste jälgimisteenuse taga.",
    ...
    mission: {
      ...
      items: {
        0: {
          description:
            "Vabane vajadusest pidevalt mitmel veebilehel lehte värskendada, automatiseeri otsinguprotsess ja saa õigel ajal teavitusi.",
          title: "Säästa aega",
        },
        1: {
          description:
            "Ole esimene, kes saab teada suurepärasest pakkumisest – see annab sulle eelise konkurentsitihedal turul, kus ajastus on kõik.",
          title: "Leia paremaid pakkumisi",
        },
        2: {
          description:
            "Tee teadlikke otsuseid, jälgides põhjalikult mitmeid usaldusväärseid autoportaalide platvorme.",
          title: "Osta kindlalt",
        },
      },
    },
    questions: {
      description:
        "Uuri lähemalt, kuidas meie teenus töötab, vaata hinnavalikuid või võta ühendust meie tugitiimiga.",
  ...
  alertSchema: {
    errors: {
      ...
      facebookmarketplaceurl:
        "Facebook Marketplace’i URL on kohustuslik, kui on valitud Facebook",
  ...
  carDetails: {
    ...
    description:
      "Täpsusta otsitava auto andmed. Kõik väljad on vabatahtlikud – jäta mõni tühjaks, et saada laiem valik tulemusi.",
    errors: {
      carbrand: "Autobränd on kohustuslik",
      carmodel: "Auto mudel on kohustuslik",
      fueltype: "Kütuse tüüp on kohustuslik",
  ...
  dashboardPayment: {
    add: "Lisa makseviis",
    description:
      "Lisa uus krediit- või deebetkaart oma tellimuse maksete jaoks.",
  ...
  dashboardPaymentMethodCard: {
    ...
    remove: "Eemalda",
    removedescription:
      "Kas oled kindel, et soovid eemaldada oma {{brand}} kaardi, mille lõpus on {{last4}}?",
    removetitle: "Eemalda makseviis",
    removewarning:
      "See on sinu vaikimisi makseviis ja selle eemaldamine võib mõjutada sinu aktiivseid tellimusi.",
    setasdefault: "Määra vaikimisi",
    setdefaultdescription:
      "Kas soovite määrata {{brand}} kaardi, mille lõpus on {{last4}}, oma vaikimisi makseviisiks? Seda kaarti kasutatakse kõigi tulevaste tellimusmaksete jaoks.",
    setdefaulttitle: "Määra vaikimisi makseviis",
  },
  dashboardSubscriptionCard: {
    cancelalert: "Tühista hoiatus",
    canceldescription:
      "Kas oled kindel, et soovid tühistada oma auto teavituse {{brand}} {{model}} jaoks? Sellega lõpetatakse kõik teavitused ja kui soovid seda autot uuesti jälgida, pead looma uue teavituse.",
  ...
  faq: {
    ...
    questions: {
      0: {
        answer:
          "Teavituste kiirus sõltub sinu valitud uuenduste sagedusest. Vaikimisi tunniplaaniga saad teavitused uue kuulutuse lisamisest kuni tunni jooksul. Peaaegu reaalajas teavituste (mõne minuti jooksul pärast kuulutuse lisamist) saamiseks saad uuendada meie sagedasema uuendamise plaanile.",
        question: "Kui kiiresti saan teavituse pärast uue kuulutuse lisamist?",
      },
      1: {
        answer:
          "Jah! Saad luua mitu otsinguprofiili erinevate kriteeriumitega. Iga profiil arvestatakse eraldi tellimusena, kuid kõiki saad hallata ühest kontost. See on ideaalne, kui otsid korraga erinevat tüüpi sõidukeid.",
        question: "Kas ma saan korraga jälgida mitut erinevat tüüpi autot?",
      },
      2: {
        answer:
          "Praegu toetame peamisi autokuulutuste platvorme, sealhulgas AutoTrader, CarGurus, Cars.com ja Facebook Marketplace. Laiendame pidevalt oma katvust, et lisada rohkem veebilehti vastavalt kasutajate soovidele ja piirkondlikule populaarsusele.",
        question: "Milliseid veebisaite te praegu toetate?",
      },
      3: {
        answer:
          "Üldsegi mitte! Pakume samm-sammult juhiseid nii teksti kui ka videote abil, et aidata sul Telegrami boti seadistada. Enamik kasutajaid saab seadistamisega hakkama vähem kui 5 minutiga, isegi ilma tehnilise taustata.",
        question:
          "Kas mul on vaja tehnilisi teadmisi, et kasutada Telegrami boti?",
      },
      4: {
        answer:
          "Jah, saad oma otsingukriteeriume igal ajal muuta oma konto juhtpaneelil. Muudatused jõustuvad kohe ning sinu teavitused uuenevad vastavalt ilma teenuse katkestuseta.",
        question:
          "Kas ma saan pärast tellimuse seadistamist oma otsingukriteeriume muuta?",
      },
      5: {
        answer:
          "Saad oma tellimuse igal ajal tühistada oma konto juhtpaneelil. Mine jaotisse „Tellimused“, vali tellimus, mida soovid tühistada, ja klõpsa nupul „Tühista tellimus“. Sinu teenus jääb aktiivseks kuni praeguse arveldusperioodi lõpuni.",
        question: "Kuidas saan oma tellimuse tühistada?",
      },
    },
    subtitle:
      "Leia vastused kõige levinumatele küsimustele meie teenuse kohta.",
  ...
  faqs: {
    general: {
      ...
      whatis: {
        answer:
          "AMIQUUS on teenus, mis jälgib mitut auto kuulutuste veebilehte, et leida sõidukeid, mis vastavad sinu konkreetsetele kriteeriumitele. Kui ilmub sobiv kuulutus, saad kohe teavituse Telegrami kaudu, võimaldades sul olla üks esimestest, kes müüjatega ühendust võtab ja häid diile kindlustab.",
        question: "Mis on Amiquus?",
      },
      whichwebsites: {
        answerintro:
          "Praegu jälgime järgmisi peamisi auto kuulutuste platvorme:",
        list: {
          0: "AutoTrader",
          1: "AMIQUUS",
          2: "AMIQUUS",
        ...
        outro:
          "Lisame pidevalt uusi platvorme, et tagada võimalikult lai ja põhjalik katvus.",
        question: "Milliseid auto müügikuulutuste veebilehti te jälgite?",
      },
    },
    metaDescription:
      "Leia vastused kõige levinumatele küsimustele AMIQUUS-i autokuulutuste jälgimisteenuse, tellimuste, teavituste seadistamise ja muu kohta.",
    ...
    subscription: {
      cancel: {
        ...
        stepsintro:
          "Saad oma tellimuse igal ajal tühistada oma konto profiililehel.",
      },
      cost: {
        answer: {
      ...
      limit: {
        ...
        outro:
          "Kui oleme täituvuse saavutanud, saate liituda meie ootenimekirjaga, et saada teavitus, kui koht vabaneb.",
        question: "Miks on tellijate arvule piirang?",
      },
      multiple: {
        answer:
          "Jah, ühe konto all saad luua mitu tellimust. Iga tellimus saab jälgida erinevaid automudeleid, -brände või hinnaklasse. See on eriti kasulik, kui otsid mitut autot või aitad sõpru ja peret auto leidmisel.",
        question: "Kas ma saan tellida mitu erinevate automudelite tellimust?",
      },
    },
    subtitle:
      "Leia kiireid vastuseid levinud küsimustele meie autokuulutuste jälgimisteenuse kohta",
    support: {
      button: "Võta ühendust klienditoega",
      description:
        "Kui sa ei leidnud oma küsimusele vastust, on meie klienditugi valmis sind aitama!",
    ...
    technical: {
      frequency: {
        ...
        outro:
          "Teavitusi saad ainult siis, kui leitakse uusi kuulutusi, mis vastavad sinu kriteeriumidele.",
        question: "Kui tihti ma saan teavitusi?",
      },
      heading: "Tehnilised küsimused",
      privacy: {
        intro:
          "Võtame andmete privaatsust tõsiselt ja rakendame järgmisi meetmeid:",
        list: {
  ...
  features: {
    account: {
      description:
        "Halda mitut otsinguprofiili ja muuda oma tellimuse seadeid vaid paari klikiga.",
      title: "Lihtne konto haldamine",
    },
    filters: {
      description:
        "Sea täpsed otsingukriteeriumid, sh mark, mudel, aasta, läbisõit ja hinnavahemik, et leida just see, mida soovid.",
      title: "Kohandatud filtrid",
    },
    frequency: {
      description:
        "Vali, kui tihti me uusi kuulutusi kontrollime – alates tunnipõhistest uuendustest kuni reaalajas jälgimiseni.",
    ...
    multisite: {
      description:
        "Jälgi mitut auto kuulutuste veebilehte korraga, ilma et peaksid igaüht eraldi käsitsi kontrollima.",
      title: "Mitme saidi jälgimine",
    },
    notifications: {
      description:
        "Saad kohe teateid Telegrami kaudu, kui müüki ilmub sinu kriteeriumitele vastav auto.",
      title: "Kohesed teavitused",
    },
    subheading:
      "Säästa aega ja ära jää kunagi ilma oma ideaalautost tänu meie automaatsele jälgimisteenusele.",
  },
  footer: {
    about: "Meist",
    blog: "Blogi",
    branddescription:
      "Sinu isiklik abiline, kes aitab leida ideaalse kasutatud auto pakkumise just õigel ajal.",
    brandtitle: "Amiquus",
    careers: "Karjäär",
    contact: "Kontakt",
  ...
  hero: {
    ...
    subtitle:
      "Amiquus annab sulle koheselt teada, kui sinu unistuste auto ilmub müüki mitmele autoportaalile. Saa teavitused Telegrami kaudu kohe, kui sobiv pakkumine leitakse.",
  ...
  howItWorks: {
    ...
    notificationmockup2: {
      description:
        "Mercedes C-klass, 2020, 30 000 miili – Hind langetatud 2 000 $ võrra",
    ...
    steps: {
      findcar: {
        description:
          "Ole esimene, kes saab teada uutest kuulutustest ja kindlusta parimad pakkumised enne kõiki teisi.",
        title: "Leia oma ideaalne auto",
      },
      notifications: {
        description:
          "Saad teavituse kohe, kui mõnel meie jälgitaval veebilehel ilmub sinu kriteeriumitele vastav auto.",
        title: "Saate kohesed teavitused",
      },
      preferences: {
        description:
          "Vali autobrändid, mudelid, hinnavahemik ja muud kriteeriumid, mida soovid jälgida.",
        title: "Seadista oma eelistused",
      },
      telegram: {
        description:
          "Seo oma Telegrami konto, et saada koheseid teavitusi uutest kuulutustest.",
        title: "Ühenda Telegram",
      },
    },
    subtitle:
      "Seadista korra ja lase meie automatiseeritud süsteemil leida sulle ideaalne autotehing.",
  ...
  limited: {
    available: {
      ...
      description:
        "{{active}} {{capacity}}st tellimusest on hetkel aktiivne. Ruumi liitujatele jagub!",
      title: "Saadaval tellimused",
    },
    full: {
      buttonText: "Liitu ootenimekirjaga",
      description:
        "Oleme jõudnud oma 30 aktiivse tellija piirini. Liitu ootenimekirjaga, et saada teavitus, kui koht vabaneb.",
      title: "Tellimuse limiit on saavutatud",
    },
    limited: {
      buttonText: "Alusta kohe",
      description:
        "Alles on vaid {{remaining}} kohta {{capacity}}-st. Liitu kohe, enne kui kohad täituvad!",
      title: "Piiratud saadavus",
    },
  },
  login: {
    description:
      "Sisesta oma e-posti aadress ja parool, et pääseda oma juhtpaneelile",
    emaillabel: "E-post",
    errors: {
  ...
  loginPrompt: {
    description:
      "Jätkamiseks peate olema sisse logitud. Palun logige sisse või registreeruge.",
    login: "Logi sisse",
  ...
  pricing: {
    ...
    button: "Alusta kohe",
    footernote:
      "Kõik paketid sisaldavad piiramatuid otsinguseadeid ja lihtsat tellimuse haldamist.",
    includedfeatures: {
    ...
    subtitle:
      "Meie hinnad põhinevad sinu konkreetsetel vajadustel. Alusta baaspaketist ja kohanda seda vastavalt oma soovidele.",
    title: "Lihtne ja läbipaistev hinnakujundus",
  },
  privacy: {
    lastupdated: "Viimati uuendatud: 21. mai 2025",
    metaDescription:
      "Tutvu, kuidas AMIQUUS käsitleb sinu isikuandmeid, privaatsusõigusi ja andmete kogumise tavasid.",
  ...
  profile: {
    ...
    alerts: {
      ...
      warning:
        "⚠️ Muudatused sinu tellimuses jõustuvad järgmises arveldusperioodis ja alles pärast edukat makset. Kui makse ebaõnnestub, jääb sinu praegune teavituste seadistus muutumatuks.",
    },
    logout: {
  ...
  review: {
    ...
    description:
      "Palun vaadake oma tellimuse andmed enne maksmisega jätkamist üle.",
    monitoring: {
  ...
  setupAlerts: {
    ...
    subtitle:
      "Seadista oma Telegrami bot, et saada teavitusi oma unistuste autost",
    title: "Seadista oma auto teavitused",
    toasts: {
      contactbot: {
        description:
          "Autoteadete saamiseks pead alustama vestlust meie Telegrami botiga ja saatma sõnumi. Palun järgi allolevaid juhiseid, et botiga ühendust võtta.",
  ...
  signUp: {
    ...
    subheading:
      "Seadista oma isikupärastatud autokuulutuste teavitused vaid mõne sammuga.",
    toast: {
      error: {
        description:
          "Me ei saanud teie tellimust luua. Palun proovige hiljem uuesti.",
    ...
    waitlist: {
      ...
      message:
        "Hetkel on kõik kohad täis. Liitu ootenimekirjaga, et saada teavitus, kui koht vabaneb.",
    },
  },
  subscription: {
    actions: {
    ...
    description:
      "Saad oma tellimuse igal ajal peatada. Kui peatad tellimuse, siis sinu auto teavitused peatuvad, kuni need uuesti aktiveerid.",
    ...
    toasts: {
      ...
      priceerror: {
        description:
          "Sa peatad ja uuendad oma tellimuse hinda samaaegselt. Pead kas peatama või uuendama hinna.",
        title: "Ei saa tellimust uuendada",
      },
      success: {
        description:
          "Teie tellimus brändile {{brand}} {{model}} on edukalt uuendatud",
  ...
  support: {
    ...
    faqs: {
      cancel: {
        answer:
          "Saad oma tellimuse igal ajal tühistada oma konto profiililehel. Klõpsa vahekaardil „Tellimused“, leia tellimus, mida soovid tühistada, ning vajuta nupule „Tühista tellimus“. Sinu teenus jääb aktiivseks kuni sinu praeguse arveldusperioodi lõpuni.",
        question: "Kuidas saan oma tellimuse tühistada?",
      },
      facebook: {
        answer:
          "Jah, toetame Facebook Marketplace’i jälgimist. Selle seadistamiseks tuleb sul esitada Facebook Marketplace’i otsingutulemuste lehe URL koos soovitud filtritega. Meie süsteem jälgib seejärel just seda otsingut, et leida uusi kuulutusi, mis vastavad sinu kriteeriumitele.",
        question: "Kas ma saan jälgida Facebook Marketplace’i?",
      },
      full: {
        answer:
          "Selleks, et hoida meie teenuse kõrget kvaliteeti, piirame aktiivsete tellimuste arvu. Kui kõik kohad on täis, saate liituda meie ootenimekirjaga. Anname teile teada kohe, kui vabaneb koht, ning teil on eelis see endale saada enne, kui avame selle laiemale avalikkusele.",
        question: "Mis juhtub, kui kõik tellimiskohad on täis?",
      },
      telegram: {
        intro: "Telegrami teavituste seadistamiseks järgi neid samme:",
        outro:
          "Kui vajad rohkem abi, leiad meie üksikasjaliku juhendi oma juhtpaneelilt.",
        question: "Kuidas seadistada Telegrami teavitusi?",
        steps: {
      ...
      updates: {
        answer:
          "Uuenduste sagedus sõltub sinu tellimuspaketist. Põhipaketid saavad uuendusi iga 6 tunni järel, samas kui Premium paketid võivad saada uuendusi lausa iga 30 minuti tagant. Oma praegust uuenduste sagedust saad vaadata ja muuta tellimuse seadetes.",
        question: "Kui tihti autokuulutusi uuendatakse?",
      },
    },
    metaDescription:
      "Saate abi oma AMIQUUS konto, tellimuse või autohoiatusete kohta. Sirvige meie abikeskust või võtke abi saamiseks ühendust meie tugitiimiga.",
    metaTitle: "Tugi | Amiquus – Abikeskus",
    stillneedhelp: {
      button: "Võta ühendust klienditoega",
      description:
        "Kui sa ei leidnud oma küsimusele vastust, võta julgelt ühendust meie tugitiimiga. Oleme siin, et sind aidata!",
      heading: "Kas vajad veel abi?",
    },
    subtitle:
      "Leia vastused levinud küsimustele või võta ühendust meie tugitiimiga",
    title: "Klienditugi",
  },
  telegram: {
    actions: {
    ...
    bottokenexample:
      "Muidugi! Palun edasta tekst, mida soovid tõlkida eesti keelde.",
    ...
    contactbotinstruction:
      "Alusta vestlust meie Telegrami botiga, klõpsates alloleval lingil ja saates sellele sõnumi:",
    contactbotnote:
      "See on vajalik autoalarmi teadete saamiseks. Kui oled arvutis, saad skaneerida QR-koodi.",
    description:
      "Seadista Telegrami teavitused, sisestades oma boti tokeni ja vestluse ID.",
    errors: {
    ...
    helptitle:
      "Kas vajad abi oma Telegrami boti tokeni ja Chat ID seadistamisel?",
    ...
    usernamedescription:
      "See on sinu Telegrami konto kasutajanimi (ilma @-märgita).",
  ...
  terms: {
    lastupdated: "Viimati uuendatud: 21. mai 2025",
    metaDescription:
      "Lugege AMIQUUS-i kasutustingimusi, mis reguleerivad teie kasutust meie autokuulutuste jälgimis- ja teavitusteenuses.",
  ...
  verifyEmail: {
    ...
    toast: {
      ...
      sameemaildesc:
        "Uus e-posti aadress on sama, mis praegune e-posti aadress.",
  ...
  waitlist: {
    ...
    form: {
      email: {
        description:
          "Kasutame seda e-posti aadressi, et teavitada sind, kui koht vabaneb.",
        label: "E-post",
    ...
    limited: {
      available:
        "{{remaining}} tellimiskohta {{capacity}} võimalikust on hetkel saadaval.",
      description:
        "Piirame oma süsteemi vaid 30 aktiivse tellijaga, et tagada:",
    ...
    metaDescription:
      "Liitu AMIQUUS-i ootenimekirjaga, et saada teavitus, kui tellimused muutuvad kättesaadavaks.",
    metaTitle: "Liitu ootenimekirjaga – Amiquus",
    subtitle:
      "Suure nõudluse tõttu piirame aktiivsete tellimuste arvu, et tagada kõigile kasutajatele parim teenuse kvaliteet.",
    success: {
      button: "Tagasi avalehele",
      description: "Anname teile teada, kui tellimiskoht vabaneb.",
      message:
        "Aitäh huvi eest Amiquuse vastu! Oleme teid lisanud ootenimekirja ja võtame teiega ühendust niipea, kui vabaneb koht.",
  ...
  waitlistPrompt: {
    ...
    description:
      "Hetkel on kõik kohad täis. Liitu ootenimekirjaga, et saada teavitus, kui vabaneb koht.",
    title: "Liitu ootenimekirjaga",
  },
  websiteSelection: {
    actions: {
    ...
    description:
      "Vali, milliseid veebisaite soovid jälgida ja kui tihti soovid uuendusi saada.",
    errors: {
      facebookurl:
        "Facebook Marketplace’i URL on kohustuslik, kui on valitud Facebook",
    ...
    help: {
      facebookurl:
        "Aseta siia oma Facebook Marketplace’i otsingutulemuste URL.",
      updatefrequency:
        "Kui tihti peaksime uusi kuulutusi kontrollima? Suurem sagedus võib kaasa tuua kõrgemad kulud.",
      videodesc: "Vaata allolevat videot samm-sammuliste juhiste saamiseks.",
      videotitle:
        "Kas vajad abi oma Facebook Marketplace’i otselingi leidmisel?",
