export const vi = {
  about: {
    description:
      "Chúng tôi đang cách mạng hóa cách mọi người tìm kiếm chiếc xe đã qua sử dụng hoàn hảo của mình bằng cách mang công nghệ giám sát tiên tiến đến với tất cả mọi người.",
    join: {
      cta: "Xem các vị trí tuyển dụng",
      description:
        "Chúng tôi luôn tìm kiếm những cá nhân tài năng, đam mê công nghệ và mong muốn thay đổi cách mọi người mua xe. Khám phá các vị trí tuyển dụng hiện tại và cùng AMIQUUS thực hiện sứ mệnh này.",
      heading: "Gia nhập đội ngũ của chúng tôi",
    },
    meta: {
      description:
        "Tìm hiểu về AMIQUUS, sứ mệnh của chúng tôi trong việc cách mạng hóa mua bán ô tô đã qua sử dụng, và đội ngũ đứng sau dịch vụ giám sát tin đăng xe thông minh.",
    ...
    mission: {
      ...
      items: {
        0: {
          description:
            "Loại bỏ việc phải liên tục làm mới nhiều trang web bằng cách tự động hóa quá trình tìm kiếm và nhận thông báo kịp thời.",
          title: "Tiết kiệm thời gian",
        },
        1: {
          description:
            "Hãy là người đầu tiên biết khi có ưu đãi hấp dẫn xuất hiện, giúp bạn nắm lợi thế trên thị trường cạnh tranh nơi thời gian là yếu tố quyết định.",
          title: "Tìm ưu đãi tốt hơn",
        },
        2: {
          description:
            "Đưa ra quyết định chính xác với hệ thống giám sát toàn diện trên nhiều nền tảng đăng tin ô tô uy tín.",
    ...
    questions: {
      description:
        "Tìm hiểu thêm về cách AMIQUUS hoạt động, xem các gói giá hoặc liên hệ với đội ngũ hỗ trợ của chúng tôi.",
  ...
  alertSchema: {
    errors: {
      ...
      facebookmarketplaceurl:
        "URL Facebook Marketplace là bắt buộc khi bạn chọn Facebook",
  ...
  carDetails: {
    ...
    description:
      "Nhập thông tin xe bạn muốn tìm. Tất cả các trường đều không bắt buộc – để trống nếu muốn xem nhiều kết quả hơn.",
    errors: {
      carbrand: "Hãng xe là bắt buộc",
      carmodel: "Vui lòng nhập mẫu xe",
      fueltype: "Loại nhiên liệu là bắt buộc",
  ...
  dashboardPayment: {
    ...
    description:
      "Thêm thẻ tín dụng hoặc thẻ ghi nợ mới để thanh toán đăng ký của bạn.",
  ...
  dashboardPaymentMethodCard: {
    ...
    remove: "Xóa",
    removedescription:
      "Bạn có chắc chắn muốn xóa thẻ {{brand}} có số kết thúc là {{last4}} không?",
    removetitle: "Xóa phương thức thanh toán",
    removewarning:
      "Đây là phương thức thanh toán mặc định của bạn và việc xóa nó có thể ảnh hưởng đến các gói đăng ký đang hoạt động của bạn.",
    setasdefault: "Đặt làm mặc định",
    setdefaultdescription:
      "Bạn có muốn đặt thẻ {{brand}} có số kết thúc là {{last4}} làm phương thức thanh toán mặc định không? Thẻ này sẽ được sử dụng cho tất cả các khoản thanh toán gia hạn sau này.",
    setdefaulttitle: "Đặt phương thức thanh toán mặc định",
  },
  dashboardSubscriptionCard: {
    cancelalert: "Hủy cảnh báo",
    canceldescription:
      "Bạn có chắc chắn muốn hủy cảnh báo xe cho {{brand}} {{model}} không? Việc này sẽ dừng tất cả thông báo và bạn sẽ cần tạo cảnh báo mới nếu muốn tiếp tục theo dõi xe này.",
  ...
  faq: {
    ...
    questions: {
      0: {
        answer:
          "Tốc độ nhận thông báo phụ thuộc vào tần suất cập nhật mà bạn chọn. Với gói mặc định cập nhật mỗi giờ, bạn sẽ nhận được thông báo trong vòng một giờ sau khi có tin đăng mới. Nếu muốn nhận thông báo gần như ngay lập tức (chỉ trong vài phút sau khi đăng), bạn có thể nâng cấp lên các gói cập nhật thường xuyên hơn của chúng tôi.",
        question:
          "Tôi sẽ nhận được thông báo sau khi có tin đăng mới trong bao lâu?",
      },
      1: {
        answer:
          "Vâng! Bạn có thể tạo nhiều hồ sơ tìm kiếm với các tiêu chí khác nhau. Mỗi hồ sơ được tính là một gói đăng ký riêng biệt, nhưng bạn có thể quản lý tất cả chỉ với một tài khoản. Điều này rất phù hợp nếu bạn đang tìm kiếm nhiều loại phương tiện cùng lúc.",
        question: "Tôi có thể theo dõi nhiều loại xe khác nhau cùng lúc không?",
      },
      2: {
        answer:
          "Hiện tại, chúng tôi hỗ trợ các nền tảng đăng tin mua bán ô tô lớn như AutoTrader, CarGurus, Cars.com và Facebook Marketplace. AMIQUUS luôn mở rộng phạm vi hỗ trợ để tích hợp thêm nhiều website dựa trên nhu cầu người dùng và mức độ phổ biến tại từng khu vực.",
        question: "Hiện tại bạn hỗ trợ những trang web nào?",
      },
      3: {
        answer:
          "Hoàn toàn không! Chúng tôi cung cấp hướng dẫn từng bước bằng cả văn bản và video để bạn dễ dàng cài đặt bot Telegram. Hầu hết người dùng chỉ mất chưa đến 5 phút để hoàn tất, ngay cả khi không có kiến thức kỹ thuật.",
        question:
          "Tôi có cần kiến thức kỹ thuật để sử dụng bot Telegram không?",
      },
      4: {
        answer:
          "Vâng, bạn có thể thay đổi tiêu chí tìm kiếm bất cứ lúc nào từ bảng điều khiển tài khoản của mình. Các thay đổi sẽ có hiệu lực ngay lập tức và thông báo của bạn sẽ được cập nhật tương ứng mà không làm gián đoạn dịch vụ.",
        question:
          "Tôi có thể thay đổi tiêu chí tìm kiếm sau khi đã thiết lập đăng ký không?",
      },
      5: {
        answer:
          'Bạn có thể hủy gói đăng ký bất cứ lúc nào trong trang quản lý tài khoản của mình. Vào mục "Đăng ký", chọn gói bạn muốn hủy và nhấn nút "Hủy đăng ký". Dịch vụ của bạn sẽ tiếp tục hoạt động đến hết chu kỳ thanh toán hiện tại.',
  ...
  faqs: {
    general: {
      ...
      whichwebsites: {
        ...
        outro:
          "Chúng tôi liên tục bổ sung thêm nền tảng mới để mang đến phạm vi phủ sóng toàn diện nhất.",
        question: "Bạn theo dõi những trang web đăng tin bán ô tô nào?",
      },
    },
    metaDescription:
      "Tìm câu trả lời cho những thắc mắc phổ biến về dịch vụ giám sát tin đăng xe của AMIQUUS, gói đăng ký, cài đặt thông báo và nhiều nội dung khác.",
    ...
    subscription: {
      cancel: {
        ...
        stepsintro:
          "Bạn có thể hủy đăng ký bất cứ lúc nào tại trang hồ sơ tài khoản của mình:",
      },
      cost: {
        answer: {
      ...
      limit: {
        intro:
          "Chúng tôi giới hạn dịch vụ ở mức 30 người đăng ký hoạt động để đảm bảo:",
        list: {
        ...
        outro:
          "Nếu số lượng đã đầy, bạn có thể tham gia danh sách chờ để được thông báo khi có chỗ trống.",
        question: "Tại sao lại có giới hạn số lượng người đăng ký?",
      },
      multiple: {
        answer:
          "Vâng, bạn có thể tạo nhiều gói đăng ký dưới một tài khoản. Mỗi gói đăng ký có thể theo dõi các mẫu xe, thương hiệu hoặc mức giá khác nhau. Điều này đặc biệt hữu ích nếu bạn đang tìm kiếm nhiều xe hoặc hỗ trợ bạn bè, người thân trong việc tìm xe.",
        question:
          "Tôi có thể đăng ký nhiều gói cho các mẫu xe khác nhau không?",
      },
    },
    subtitle:
      "Tìm câu trả lời nhanh cho các thắc mắc thường gặp về dịch vụ giám sát tin đăng ô tô của AMIQUUS",
    support: {
      button: "Liên hệ hỗ trợ",
      description:
        "Nếu bạn chưa tìm thấy câu trả lời cho thắc mắc của mình, đội ngũ hỗ trợ của chúng tôi luôn sẵn sàng giúp đỡ bạn!",
    ...
    technical: {
      frequency: {
        ...
        outro:
          "Bạn chỉ nhận được thông báo khi có tin đăng mới phù hợp với tiêu chí của bạn.",
        question: "Tôi sẽ nhận thông báo bao lâu một lần?",
      },
      heading: "Câu hỏi kỹ thuật",
      privacy: {
        intro:
          "Chúng tôi coi trọng quyền riêng tư dữ liệu và áp dụng các biện pháp sau:",
        list: {
        ...
        outro:
          "Đọc toàn bộ Chính sách quyền riêng tư của chúng tôi để biết thêm thông tin.",
  ...
  features: {
    account: {
      description:
        "Quản lý nhiều hồ sơ tìm kiếm và thay đổi cài đặt đăng ký chỉ với vài cú nhấp chuột.",
      title: "Quản lý tài khoản dễ dàng",
    },
    filters: {
      description:
        "Đặt tiêu chí chi tiết như hãng xe, mẫu mã, năm sản xuất, số km đã đi và khoảng giá để tìm đúng chiếc xe bạn mong muốn.",
      title: "Bộ lọc tùy chỉnh",
    },
    frequency: {
      description:
        "Chọn tần suất kiểm tra tin đăng mới, từ cập nhật hàng giờ đến giám sát theo thời gian thực.",
    ...
    multisite: {
      description:
        "Theo dõi nhiều trang web đăng tin bán ô tô cùng lúc mà không cần phải kiểm tra từng trang một cách thủ công.",
      title: "Theo dõi nhiều trang web",
    },
    notifications: {
      description:
        "Nhận thông báo ngay lập tức qua Telegram khi có xe phù hợp tiêu chí của bạn được đăng bán.",
      title: "Thông báo tức thì",
    },
    subheading:
      "Tiết kiệm thời gian và không bao giờ bỏ lỡ chiếc xe hoàn hảo với dịch vụ theo dõi tự động của chúng tôi.",
  },
  footer: {
    about: "Về chúng tôi",
    blog: "Blog",
    branddescription:
      "Trợ lý cá nhân giúp bạn tìm kiếm chiếc xe cũ phù hợp với mức giá tốt nhất vào đúng thời điểm.",
    brandtitle: "Amiquus",
  ...
  hero: {
    ...
    subtitle:
      "AMIQUUS sẽ thông báo ngay lập tức khi chiếc xe mơ ước của bạn xuất hiện trên nhiều trang web rao bán xe. Nhận thông báo qua Telegram ngay khi tìm thấy kết quả phù hợp.",
  ...
  howItWorks: {
    ...
    steps: {
      findcar: {
        description:
          "Hãy là người đầu tiên biết về các tin đăng mới và săn được những ưu đãi tốt nhất trước mọi người.",
        title: "Tìm chiếc xe hoàn hảo của bạn",
      },
      notifications: {
        description:
          "Nhận thông báo ngay khi có xe phù hợp với tiêu chí của bạn xuất hiện trên bất kỳ trang web nào mà AMIQUUS đang theo dõi.",
      ...
      telegram: {
        description:
          "Kết nối tài khoản Telegram của bạn để nhận thông báo ngay lập tức về các tin đăng mới.",
        title: "Kết nối Telegram",
      },
    },
    subtitle:
      "Chỉ cần thiết lập một lần, hệ thống tự động của chúng tôi sẽ tìm cho bạn chiếc xe phù hợp nhất.",
  ...
  limited: {
    available: {
      ...
      description:
        "Hiện có {{active}} trên tổng số {{capacity}} gói đăng ký đang hoạt động. Vẫn còn nhiều chỗ để bạn tham gia!",
      title: "Các gói đăng ký hiện có",
    },
    full: {
      buttonText: "Tham gia danh sách chờ",
      description:
        "Chúng tôi đã đạt giới hạn 30 người đăng ký đang hoạt động. Hãy tham gia danh sách chờ để được thông báo khi có chỗ trống.",
      title: "Đã đạt giới hạn đăng ký",
    },
    limited: {
      buttonText: "Bắt đầu ngay",
      description:
        "Chỉ còn {{remaining}} chỗ trống trên tổng số {{capacity}}. Đăng ký ngay trước khi hết chỗ!",
  ...
  payment: {
    ...
    toast: {
      ...
      success: {
        description:
          "Phương thức thanh toán của bạn đã được thiết lập thành công.",
        title: "Thành công",
      },
    },
  },
  personalInfo: {
    ...
    description:
      "Vui lòng cung cấp thông tin cá nhân của bạn để chúng tôi có thể thiết lập thông báo cho bạn một cách chính xác.",
    errors: {
  ...
  pricing: {
    ...
    button: "Bắt đầu ngay",
    footernote:
      "Tất cả gói đều bao gồm cấu hình tìm kiếm không giới hạn và quản lý đăng ký dễ dàng.",
    includedfeatures: {
    ...
    subtitle:
      "Giá của chúng tôi được xây dựng dựa trên nhu cầu riêng của bạn. Hãy bắt đầu với gói cơ bản và tuỳ chỉnh theo yêu cầu của bạn.",
    title: "Giá cả minh bạch, đơn giản",
  },
  privacy: {
    lastupdated: "Cập nhật lần cuối: 21 tháng 5, 2025",
    metaDescription:
      "Tìm hiểu cách AMIQUUS xử lý dữ liệu cá nhân, quyền riêng tư và các hoạt động thu thập dữ liệu của bạn.",
  ...
  profile: {
    ...
    alerts: {
      ...
      warning:
        "⚠️ Các thay đổi đối với gói đăng ký của bạn sẽ được áp dụng vào kỳ thanh toán tiếp theo và chỉ sau khi thanh toán thành công. Nếu thanh toán không thành công, cài đặt cảnh báo hiện tại của bạn sẽ được giữ nguyên.",
    },
    logout: {
  ...
  review: {
    ...
    description:
      "Vui lòng kiểm tra lại thông tin đăng ký của bạn trước khi tiến hành thanh toán.",
    monitoring: {
  ...
  setupAlerts: {
    ...
    subtitle:
      "Cấu hình bot Telegram của bạn để nhận thông báo về chiếc xe mơ ước của bạn",
    title: "Thiết lập cảnh báo cho xe của bạn",
    toasts: {
      contactbot: {
        description:
          "Bạn cần bắt đầu trò chuyện với bot Telegram của chúng tôi và gửi một tin nhắn để nhận thông báo về xe. Vui lòng làm theo hướng dẫn bên dưới để liên hệ với bot.",
  ...
  signUp: {
    ...
    subheading:
      "Thiết lập thông báo tin đăng xe cá nhân hóa chỉ với vài bước đơn giản.",
    toast: {
      error: {
        description:
          "Chúng tôi không thể tạo đăng ký của bạn. Vui lòng thử lại sau.",
        title: "Đăng ký không thành công",
      },
      success: {
        description: "Đăng ký của bạn đã được tạo thành công",
    ...
    waitlist: {
      ...
      message:
        "Hiện tại chúng tôi đã kín chỗ. Vui lòng tham gia danh sách chờ để được thông báo khi có chỗ trống.",
    },
  },
  subscription: {
    actions: {
    ...
    description:
      "Bạn có thể tạm dừng gói đăng ký bất cứ lúc nào. Khi tạm dừng, các cảnh báo về xe của bạn sẽ ngừng gửi cho đến khi bạn kích hoạt lại.",
    ...
    toasts: {
      ...
      priceerror: {
        description:
          "Bạn đang tạm dừng và cập nhật giá gói đăng ký cùng lúc. Vui lòng chỉ tạm dừng hoặc cập nhật giá.",
        title: "Không thể cập nhật gói đăng ký",
      },
      success: {
        description:
          "Đăng ký của bạn cho {{brand}} {{model}} đã được cập nhật thành công",
  ...
  support: {
    emailsupport: {
      description:
        "Gửi cho chúng tôi email và chúng tôi sẽ phản hồi bạn trong vòng 24 giờ",
      email: "support@amiquus.com",
    ...
    faqs: {
      cancel: {
        answer:
          'Bạn có thể hủy gói đăng ký bất cứ lúc nào tại trang hồ sơ tài khoản của mình. Nhấn vào tab "Đăng ký", tìm gói bạn muốn hủy và nhấn nút "Hủy đăng ký". Dịch vụ của bạn sẽ tiếp tục cho đến hết chu kỳ thanh toán hiện tại.',
        question: "Làm sao để hủy đăng ký của tôi?",
      },
      facebook: {
        answer:
          "Vâng, chúng tôi hỗ trợ theo dõi Facebook Marketplace. Để thiết lập, bạn cần cung cấp đường dẫn URL tới trang kết quả tìm kiếm trên Facebook Marketplace với các bộ lọc mong muốn đã được áp dụng. Hệ thống của chúng tôi sẽ theo dõi chính xác tìm kiếm đó để phát hiện các tin đăng mới phù hợp với tiêu chí của bạn.",
        question: "Tôi có thể theo dõi Facebook Marketplace không?",
      },
      full: {
        answer:
          "Để đảm bảo chất lượng dịch vụ luôn ở mức cao, chúng tôi giới hạn số lượng đăng ký đang hoạt động. Nếu tất cả các suất đều đã đầy, bạn có thể tham gia danh sách chờ của chúng tôi. Chúng tôi sẽ thông báo cho bạn ngay khi có suất trống và bạn sẽ được ưu tiên đăng ký trước khi mở cho công chúng.",
      ...
      telegram: {
        ...
        outro:
          "Nếu bạn cần thêm trợ giúp, hướng dẫn chi tiết của chúng tôi có sẵn trong bảng điều khiển của bạn.",
        question: "Làm thế nào để cài đặt thông báo Telegram?",
        steps: {
      ...
      updates: {
        answer:
          "Tần suất cập nhật phụ thuộc vào gói đăng ký của bạn. Gói Cơ bản sẽ nhận cập nhật mỗi 6 giờ, trong khi gói Premium có thể nhận cập nhật thường xuyên tới mỗi 30 phút. Bạn có thể xem và thay đổi tần suất cập nhật hiện tại trong phần cài đặt đăng ký.",
        question: "Các tin đăng bán xe được cập nhật bao lâu một lần?",
      },
    },
    metaDescription:
      "Nhận hỗ trợ về tài khoản, gói đăng ký hoặc cảnh báo xe của bạn trên AMIQUUS. Khám phá trung tâm trợ giúp hoặc liên hệ đội ngũ hỗ trợ của chúng tôi để được giúp đỡ.",
    metaTitle: "Hỗ trợ | Amiquus - Trung tâm trợ giúp",
    stillneedhelp: {
      button: "Liên hệ hỗ trợ",
      description:
        "Nếu bạn chưa tìm thấy câu trả lời cho thắc mắc của mình, đừng ngần ngại liên hệ với đội ngũ hỗ trợ của AMIQUUS. Chúng tôi luôn sẵn sàng giúp bạn!",
  ...
  telegram: {
    ...
    chatiddescription:
      "Bạn có thể lấy thông tin này bằng cách nhắn tin cho @userinfobot trên Telegram.",
    ...
    contactbotinstruction:
      "Bắt đầu trò chuyện với bot Telegram của chúng tôi bằng cách nhấp vào liên kết bên dưới và gửi tin nhắn cho bot:",
    contactbotnote:
      "Bạn cần làm điều này để nhận thông báo về xe. Nếu đang dùng máy tính, bạn có thể quét mã QR.",
    description:
      "Thiết lập thông báo Telegram bằng cách nhập token bot và ID trò chuyện.",
    errors: {
    ...
    instructions: {
      ...
      chatstep3:
        "Bot sẽ trả lời với thông tin của bạn bao gồm cả Chat ID của bạn",
    ...
    videodescription:
      "Xem video bên dưới để được hướng dẫn chi tiết từng bước.",
  ...
  terms: {
    lastupdated: "Cập nhật lần cuối: 21 tháng 5, 2025",
    metaDescription:
      "Đọc Điều khoản Dịch vụ của AMIQUUS điều chỉnh việc sử dụng dịch vụ theo dõi và thông báo tin đăng xe của bạn.",
  ...
  waitlist: {
    cantjoin: {
      description:
        "Chúng tôi sẽ thông báo cho bạn ngay khi có chỗ đăng ký mới.",
      title: "Tham gia danh sách chờ",
    },
    form: {
      email: {
        description:
          "Chúng tôi sẽ dùng email này để thông báo cho bạn khi có chỗ trống.",
        label: "Email",
    ...
    limited: {
      available:
        "Hiện còn {{remaining}} suất đăng ký trên tổng số {{capacity}} suất.",
      description:
        "Chúng tôi giới hạn hệ thống chỉ còn 30 người đăng ký hoạt động để đảm bảo:",
    ...
    metaDescription:
      "Tham gia danh sách chờ của AMIQUUS để nhận thông báo khi dịch vụ đăng ký được mở.",
    metaTitle: "Tham gia danh sách chờ - Amiquus",
    subtitle:
      "Do nhu cầu sử dụng cao, chúng tôi giới hạn số lượng đăng ký hoạt động để đảm bảo chất lượng dịch vụ tốt nhất cho tất cả người dùng.",
    success: {
      button: "Quay lại trang chủ",
      description:
        "Chúng tôi sẽ thông báo cho bạn ngay khi có chỗ đăng ký mới.",
      message:
        "Cảm ơn bạn đã quan tâm đến Amiquus! Chúng tôi đã thêm bạn vào danh sách chờ và sẽ liên hệ với bạn ngay khi có suất trống.",
  ...
  waitlistPrompt: {
    ...
    description:
      "Hiện tại chúng tôi đã hết chỗ. Đăng ký vào danh sách chờ để được thông báo khi có chỗ trống.",
    title: "Tham gia danh sách chờ",
  },
  websiteSelection: {
    actions: {
    ...
    description:
      "Chọn những trang web bạn muốn theo dõi và tần suất bạn muốn nhận cập nhật.",
    errors: {
    ...
    help: {
      facebookurl:
        "Dán liên kết kết quả tìm kiếm Facebook Marketplace của bạn vào đây.",
      updatefrequency:
        "Chúng ta nên kiểm tra tin đăng mới bao lâu một lần? Tần suất kiểm tra cao hơn có thể tốn thêm chi phí.",
      videodesc: "Xem video bên dưới để được hướng dẫn từng bước.",
      videotitle:
        "Bạn cần giúp tìm liên kết tìm kiếm Facebook Marketplace của mình?",
