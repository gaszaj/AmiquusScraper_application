        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://twitter.com" className="text-neutral-500 hover:text-primary dark:text-neutral-400 dark:hover:text-primary transition-colors" aria-label="Twitter">
              ...
              <a href="https://instagram.com" className="text-neutral-500 hover:text-primary dark:text-neutral-400 dark:hover:text-primary transition-colors" aria-label="Instagram">
              ...
              <a href="https://linkedin.com" className="text-neutral-500 hover:text-primary dark:text-neutral-400 dark:hover:text-primary transition-colors" aria-label="LinkedIn">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 448 512">
